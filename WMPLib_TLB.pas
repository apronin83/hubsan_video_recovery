...
// $Rev: 52393 $
// File generated on 13.06.2017 16:58:46 from Type Library described below.
...
const
  ...
  IID_IWMPDolbyDigitalSettingsCtrl: TGUID = '{BBD6801A-A1D4-4D05-9F2D-29E0024C3FD9}';
  CLASS_WMPDolbyDigitalSettingsCtrl: TGUID = '{1EA16D11-DCB1-41FE-BC17-42CDFBEF8F53}';
...
// *********************************************************************//
  ...
  IWMPDolbyDigitalSettingsCtrl = interface;
  IWMPDolbyDigitalSettingsCtrlDisp = dispinterface;
...
// *********************************************************************//
  ...
  WMPDolbyDigitalSettingsCtrl = IWMPDolbyDigitalSettingsCtrl;
...
// *********************************************************************//
// Interface: IWMPDolbyDigitalSettingsCtrl
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {BBD6801A-A1D4-4D05-9F2D-29E0024C3FD9}
// *********************************************************************//
  IWMPDolbyDigitalSettingsCtrl = interface(IDispatch)
    ['{BBD6801A-A1D4-4D05-9F2D-29E0024C3FD9}']
    procedure reset; safecall;
    function Get_currentPreset: Integer; safecall;
    procedure Set_currentPreset(plCurrentPreset: Integer); safecall;
    property currentPreset: Integer read Get_currentPreset write Set_currentPreset;
  end;

// *********************************************************************//
// DispIntf:  IWMPDolbyDigitalSettingsCtrlDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {BBD6801A-A1D4-4D05-9F2D-29E0024C3FD9}
// *********************************************************************//
  IWMPDolbyDigitalSettingsCtrlDisp = dispinterface
    ['{BBD6801A-A1D4-4D05-9F2D-29E0024C3FD9}']
    procedure reset; dispid 5950;
    property currentPreset: Integer dispid 5951;
  end;
...
// *********************************************************************//
// The Class CoWMPDolbyDigitalSettingsCtrl provides a Create and CreateRemote method to          
// create instances of the default interface IWMPDolbyDigitalSettingsCtrl exposed by              
// the CoClass WMPDolbyDigitalSettingsCtrl. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoWMPDolbyDigitalSettingsCtrl = class
    class function Create: IWMPDolbyDigitalSettingsCtrl;
    class function CreateRemote(const MachineName: string): IWMPDolbyDigitalSettingsCtrl;
  end;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TWMPDolbyDigitalSettingsCtrl
// Help String      : WMPDolbyDigitalSettingsCtrl: Not Public.  Internal object used by Windows Media Player.
// Default Interface: IWMPDolbyDigitalSettingsCtrl
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (0)
// *********************************************************************//
  TWMPDolbyDigitalSettingsCtrl = class(TOleServer)
  private
    FIntf: IWMPDolbyDigitalSettingsCtrl;
    function GetDefaultInterface: IWMPDolbyDigitalSettingsCtrl;
  protected
    procedure InitServerData; override;
    function Get_currentPreset: Integer;
    procedure Set_currentPreset(plCurrentPreset: Integer);
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IWMPDolbyDigitalSettingsCtrl);
    procedure Disconnect; override;
    procedure reset;
    property DefaultInterface: IWMPDolbyDigitalSettingsCtrl read GetDefaultInterface;
    property currentPreset: Integer read Get_currentPreset write Set_currentPreset;
  published
  end;
...
class function CoWMPDolbyDigitalSettingsCtrl.Create: IWMPDolbyDigitalSettingsCtrl;
begin
  Result := CreateComObject(CLASS_WMPDolbyDigitalSettingsCtrl) as IWMPDolbyDigitalSettingsCtrl;
end;

class function CoWMPDolbyDigitalSettingsCtrl.CreateRemote(const MachineName: string): IWMPDolbyDigitalSettingsCtrl;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_WMPDolbyDigitalSettingsCtrl) as IWMPDolbyDigitalSettingsCtrl;
end;

procedure TWMPDolbyDigitalSettingsCtrl.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{1EA16D11-DCB1-41FE-BC17-42CDFBEF8F53}';
    IntfIID:   '{BBD6801A-A1D4-4D05-9F2D-29E0024C3FD9}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TWMPDolbyDigitalSettingsCtrl.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as IWMPDolbyDigitalSettingsCtrl;
  end;
end;

procedure TWMPDolbyDigitalSettingsCtrl.ConnectTo(svrIntf: IWMPDolbyDigitalSettingsCtrl);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TWMPDolbyDigitalSettingsCtrl.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TWMPDolbyDigitalSettingsCtrl.GetDefaultInterface: IWMPDolbyDigitalSettingsCtrl;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TWMPDolbyDigitalSettingsCtrl.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TWMPDolbyDigitalSettingsCtrl.Destroy;
begin
  inherited Destroy;
end;

function TWMPDolbyDigitalSettingsCtrl.Get_currentPreset: Integer;
begin
  Result := DefaultInterface.currentPreset;
end;

procedure TWMPDolbyDigitalSettingsCtrl.Set_currentPreset(plCurrentPreset: Integer);
begin
  DefaultInterface.currentPreset := plCurrentPreset;
end;

procedure TWMPDolbyDigitalSettingsCtrl.reset;
begin
  DefaultInterface.reset;
end;
...
begin
  ...
  RegisterComponents(dtlServerPage, [TWMPButtonCtrl, TWMPListBoxCtrl, TWMPSliderCtrl, TWMPVideoCtrl, 
    TWMPEffects, TWMPEqualizerSettingsCtrl, TWMPVideoSettingsCtrl, TWMPDolbyDigitalSettingsCtrl, TWMPLibraryTreeCtrl, 
    TWMPEditCtrl, TWMPSkinList, TWMPMenuCtrl, TWMPAutoMenuCtrl, TWMPRegionalButtonCtrl, 
    TWMPRegionalButton, TWMPCustomSliderCtrl, TWMPTextCtrl, TWMPPlaylistCtrl, TWMPCore]);
end;
